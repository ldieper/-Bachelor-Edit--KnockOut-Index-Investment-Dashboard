...
def prepare_investment_data(df_all_index):
    ...
    [
        (df_all_index["date"] >= "2007-07-01") & (df_all_index["date"] <= "2009-05-01"),
        (df_all_index["date"] >= "2009-06-01") & (df_all_index["date"] <= "2015-01-01"),
        ...
        (df_all_index["date"] >= "2023-03-01") & (df_all_index["date"] <= "2024-04-01"),
